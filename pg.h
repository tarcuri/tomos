...
#define PTE_USER_MODE	0x00000004	// bit 2 set if supervisor mode 
...
#define PEE_USER_MODE	0x00000004	// bit 2 set if supervisor mode 
...
{
  pde_t	*page_tables[1024];
} page_directory_t;

page_directory_t *pg_directory;
