...
enum opt_code
{
  ...
  OPT_mavx = 770,                            /* -mavx */
  OPT_mbmi = 771,                            /* -mbmi */
  OPT_mbranch_cost_ = 772,                   /* -mbranch-cost= */
  OPT_mcld = 773,                            /* -mcld */
  OPT_mcmodel_ = 774,                        /* -mcmodel= */
  /* OPT_mcpu_ = 775, */                     /* -mcpu= */
  OPT_mcrc32 = 776,                          /* -mcrc32 */
  OPT_mcx16 = 777,                           /* -mcx16 */
  OPT_mdispatch_scheduler = 778,             /* -mdispatch-scheduler */
  OPT_mf16c = 779,                           /* -mf16c */
  OPT_mfancy_math_387 = 780,                 /* -mfancy-math-387 */
  OPT_mfentry = 781,                         /* -mfentry */
  OPT_mfma = 782,                            /* -mfma */
  OPT_mfma4 = 783,                           /* -mfma4 */
  OPT_mforce_drap = 784,                     /* -mforce-drap */
  OPT_mfp_ret_in_387 = 785,                  /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 786,                        /* -mfpmath= */
  OPT_mfsgsbase = 787,                       /* -mfsgsbase */
  /* OPT_mfused_madd = 788, */               /* -mfused-madd */
  OPT_mhard_float = 789,                     /* -mhard-float */
  OPT_mieee_fp = 790,                        /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 791,       /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 792,           /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 793,   /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 794, */             /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 795,          /* -mlarge-data-threshold= */
  OPT_mlwp = 796,                            /* -mlwp */
  OPT_mmmx = 797,                            /* -mmmx */
  OPT_mmovbe = 798,                          /* -mmovbe */
  OPT_mms_bitfields = 799,                   /* -mms-bitfields */
  OPT_mno_align_stringops = 800,             /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 801,              /* -mno-fancy-math-387 */
  OPT_mno_push_args = 802,                   /* -mno-push-args */
  OPT_mno_red_zone = 803,                    /* -mno-red-zone */
  OPT_mno_sse4 = 804,                        /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 805,        /* -momit-leaf-frame-pointer */
  OPT_mpc = 806,                             /* -mpc */
  OPT_mpclmul = 807,                         /* -mpclmul */
  OPT_mpopcnt = 808,                         /* -mpopcnt */
  OPT_mprefer_avx128 = 809,                  /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 810,      /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 811,                      /* -mpush-args */
  OPT_mrdrnd = 812,                          /* -mrdrnd */
  OPT_mrecip = 813,                          /* -mrecip */
  OPT_mred_zone = 814,                       /* -mred-zone */
  OPT_mregparm_ = 815,                       /* -mregparm= */
  OPT_mrtd = 816,                            /* -mrtd */
  OPT_msahf = 817,                           /* -msahf */
  OPT_msoft_float = 818,                     /* -msoft-float */
  OPT_msse = 819,                            /* -msse */
  OPT_msse2 = 820,                           /* -msse2 */
  OPT_msse2avx = 821,                        /* -msse2avx */
  OPT_msse3 = 822,                           /* -msse3 */
  OPT_msse4 = 823,                           /* -msse4 */
  OPT_msse4_1 = 824,                         /* -msse4.1 */
  OPT_msse4_2 = 825,                         /* -msse4.2 */
  OPT_msse4a = 826,                          /* -msse4a */
  /* OPT_msse5 = 827, */                     /* -msse5 */
  OPT_msseregparm = 828,                     /* -msseregparm */
  OPT_mssse3 = 829,                          /* -mssse3 */
  OPT_mstack_arg_probe = 830,                /* -mstack-arg-probe */
  OPT_mstackrealign = 831,                   /* -mstackrealign */
  OPT_mstringop_strategy_ = 832,             /* -mstringop-strategy= */
  OPT_mtbm = 833,                            /* -mtbm */
  OPT_mtls_dialect_ = 834,                   /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 835,            /* -mtls-direct-seg-refs */
  OPT_mtune_ = 836,                          /* -mtune= */
  OPT_mveclibabi_ = 837,                     /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 838,               /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 839,                     /* -mvzeroupper */
  OPT_mxop = 840,                            /* -mxop */
  OPT_n = 841,                               /* -n */
  OPT_no_canonical_prefixes = 842,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 843,               /* -no-integrated-cpp */
  OPT_nodefaultlibs = 844,                   /* -nodefaultlibs */
  OPT_nostartfiles = 845,                    /* -nostartfiles */
  OPT_nostdinc = 846,                        /* -nostdinc */
  OPT_nostdinc__ = 847,                      /* -nostdinc++ */
  OPT_nostdlib = 848,                        /* -nostdlib */
  OPT_o = 849,                               /* -o */
  OPT_p = 850,                               /* -p */
  OPT_pass_exit_codes = 851,                 /* -pass-exit-codes */
  OPT_pedantic = 852,                        /* -pedantic */
  OPT_pedantic_errors = 853,                 /* -pedantic-errors */
  OPT_pg = 854,                              /* -pg */
  OPT_pie = 855,                             /* -pie */
  OPT_pipe = 856,                            /* -pipe */
  OPT_print_file_name_ = 857,                /* -print-file-name= */
  OPT_print_libgcc_file_name = 858,          /* -print-libgcc-file-name */
  OPT_print_multi_directory = 859,           /* -print-multi-directory */
  OPT_print_multi_lib = 860,                 /* -print-multi-lib */
  OPT_print_multi_os_directory = 861,        /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 862,         /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 863,                /* -print-prog-name= */
  OPT_print_search_dirs = 864,               /* -print-search-dirs */
  OPT_print_sysroot = 865,                   /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 866,    /* -print-sysroot-headers-suffix */
  OPT_quiet = 867,                           /* -quiet */
  OPT_r = 868,                               /* -r */
  OPT_remap = 869,                           /* -remap */
  OPT_s = 870,                               /* -s */
  OPT_save_temps = 871,                      /* -save-temps */
  OPT_save_temps_ = 872,                     /* -save-temps= */
  OPT_shared = 873,                          /* -shared */
  OPT_shared_libgcc = 874,                   /* -shared-libgcc */
  /* OPT_specs = 875, */                     /* -specs */
  OPT_specs_ = 876,                          /* -specs= */
  OPT_static = 877,                          /* -static */
  OPT_static_libgcc = 878,                   /* -static-libgcc */
  OPT_static_libgfortran = 879,              /* -static-libgfortran */
  OPT_static_libgo = 880,                    /* -static-libgo */
  OPT_static_libstdc__ = 881,                /* -static-libstdc++ */
  /* OPT_std_c__03 = 882, */                 /* -std=c++03 */
  OPT_std_c__0x = 883,                       /* -std=c++0x */
  OPT_std_c__98 = 884,                       /* -std=c++98 */
  OPT_std_c1x = 885,                         /* -std=c1x */
  /* OPT_std_c89 = 886, */                   /* -std=c89 */
  OPT_std_c90 = 887,                         /* -std=c90 */
  OPT_std_c99 = 888,                         /* -std=c99 */
  /* OPT_std_c9x = 889, */                   /* -std=c9x */
  OPT_std_gnu__0x = 890,                     /* -std=gnu++0x */
  OPT_std_gnu__98 = 891,                     /* -std=gnu++98 */
  OPT_std_gnu1x = 892,                       /* -std=gnu1x */
  /* OPT_std_gnu89 = 893, */                 /* -std=gnu89 */
  OPT_std_gnu90 = 894,                       /* -std=gnu90 */
  OPT_std_gnu99 = 895,                       /* -std=gnu99 */
  /* OPT_std_gnu9x = 896, */                 /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 897, */          /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 898,              /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 899, */          /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 900, */          /* -std=iso9899:199x */
  OPT_symbolic = 901,                        /* -symbolic */
  OPT_t = 902,                               /* -t */
  OPT_time = 903,                            /* -time */
  OPT_time_ = 904,                           /* -time= */
  OPT_traditional = 905,                     /* -traditional */
  OPT_traditional_cpp = 906,                 /* -traditional-cpp */
  OPT_trigraphs = 907,                       /* -trigraphs */
  OPT_u = 908,                               /* -u */
  OPT_undef = 909,                           /* -undef */
  OPT_v = 910,                               /* -v */
  OPT_version = 911,                         /* -version */
  OPT_w = 912,                               /* -w */
  OPT_wrapper = 913,                         /* -wrapper */
  OPT_x = 914,                               /* -x */
  OPT_z = 915,                               /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
